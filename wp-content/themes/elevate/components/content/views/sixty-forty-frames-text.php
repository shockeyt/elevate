...
<section id="flex-section-<?php echo $DATA->row_index; ?>" class="sixty-forty-frames-text bg-white py-5 py-md-6">
    <div class="container">
        <div class="row">
            <div class="anim-right col-12 order-2 order-md-1 col-md-6 col-lg-8 mt-5 mt-md-0 position-relative">
            ...
            <div class="col-12 order-1 order-md-2 col-md-6 col-lg-4">
                <div class="anim-up content text-center text-md-left px-4 pr-lg-5 py-lg-5 d-lg-rellax" data-rellax-speed="1">
