...
<section id="flex-section-<?php echo $DATA->row_index; ?>" class="product-modules py-5 py-md-6">
    <div class="container">
        <div class="row mb-5">
            <div class="anim-right col-12 offset-md-2 col-md-8 offset-lg-3 col-lg-6 text-center">
        ...
        <div class="row">
            ...
            <div class="anim-left col-12 col-md-6">
                <div class="img-w-offset-bkgd position-relative pt-5">
                    ...
                    <div class="offset-bkgd bg-light-green d-lg-rellax" data-rellax-speed="-1"></div>
                </div>
            </div>
            <?php endif; ?>
        </div>
