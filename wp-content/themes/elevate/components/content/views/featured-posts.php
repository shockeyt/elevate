...
<section id="flex-section-<?php echo $DATA->row_index; ?>" class="featured-posts overflow-hidden py-5 py-md-6">
    <div class="container">
        <div class="row">
            <div class="<?php echo($DATA->row_index == 1)? 'anim-right anim-load' : 'anim-right'; ?> col-12 text-center text-md-left mb-4 mb-md-0">
            ...
            <div class="<?php echo($DATA->row_index == 1)? 'anim-up anim-load' : 'anim-up'; ?> col-12 pb-5 pb-md-0 pt-md-6 position-relative">
                <div id="slider-count">
